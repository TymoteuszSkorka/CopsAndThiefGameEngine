...
namespace main
{
    class Board
    {
        public short m_16NumOfRows;
        public short m_16NumOfColumns;
        public int m_32ThiefPayment;
        public int m_32CopsPayment;
        public int m_32MaxNumberOfIterations;
        public int m_32CurrentIteration;
        public List<Cop> m_listOfCops;
        public List<Wall> m_listOfWalls;
        public List<Gate> m_listOfGates;
